...
module BoothMultiplierHelper_DW01_sub_0 ( A, B, CI, DIFF, CO );
  ...
  INVX0 U2 ( .IN1(B[1]), .QN(n32) );
  INVX0 U3 ( .IN1(B[2]), .QN(n31) );
  INVX0 U4 ( .IN1(B[3]), .QN(n30) );
  INVX0 U5 ( .IN1(B[4]), .QN(n29) );
  INVX0 U6 ( .IN1(B[5]), .QN(n28) );
  INVX0 U7 ( .IN1(B[6]), .QN(n27) );
  INVX0 U8 ( .IN1(B[7]), .QN(n26) );
  INVX0 U9 ( .IN1(B[8]), .QN(n25) );
  INVX0 U10 ( .IN1(B[9]), .QN(n24) );
  INVX0 U11 ( .IN1(B[10]), .QN(n23) );
  INVX0 U12 ( .IN1(B[11]), .QN(n22) );
  INVX0 U13 ( .IN1(B[12]), .QN(n21) );
  INVX0 U14 ( .IN1(B[13]), .QN(n20) );
  INVX0 U15 ( .IN1(B[14]), .QN(n19) );
  INVX0 U16 ( .IN1(B[15]), .QN(n18) );
  INVX0 U17 ( .IN1(B[16]), .QN(n17) );
  INVX0 U18 ( .IN1(B[17]), .QN(n16) );
  INVX0 U19 ( .IN1(B[18]), .QN(n15) );
  INVX0 U20 ( .IN1(B[19]), .QN(n14) );
  INVX0 U21 ( .IN1(B[20]), .QN(n13) );
  INVX0 U22 ( .IN1(B[21]), .QN(n12) );
  INVX0 U23 ( .IN1(B[22]), .QN(n11) );
  INVX0 U24 ( .IN1(B[23]), .QN(n10) );
  INVX0 U25 ( .IN1(B[24]), .QN(n9) );
  INVX0 U26 ( .IN1(B[25]), .QN(n8) );
  INVX0 U27 ( .IN1(B[26]), .QN(n7) );
  INVX0 U28 ( .IN1(B[27]), .QN(n6) );
  INVX0 U29 ( .IN1(B[28]), .QN(n5) );
  INVX0 U30 ( .IN1(B[29]), .QN(n4) );
  INVX0 U31 ( .IN1(B[30]), .QN(n3) );
  INVX0 U32 ( .IN1(B[31]), .QN(n2) );
  INVX0 U33 ( .IN1(A[0]), .QN(n1) );
  INVX0 U34 ( .IN1(B[0]), .QN(n33) );
